...
## *Author*: AAVA
## *Created on*: 
## *Description*: Enhanced Bronze Layer Physical Data Model for Zoom Platform Analytics Systems with additional source-aligned tables and improved data structure
## *Version*: 3
## *Updated on*: 
## *Changes*: Added missing tables from source structure (Users, Feature_Usage, Support_Tickets, Licenses, Billing_Events), added ID fields for better alignment with source data, improved data type precision
## *Reason*: Enhanced model to include all source entities and improve alignment with the process table structure for comprehensive data coverage
_____________________________________________

-- =====================================================
-- BRONZE LAYER PHYSICAL DATA MODEL VERSION 3
-- Zoom Platform Analytics Systems
-- Compatible with Snowflake SQL
-- =====================================================

-- 1. USERS TABLE (NEW - ALIGNED WITH SOURCE)
...
-- 2. USER ACCOUNT TABLE (ENHANCED WITH ID)
...
-- 3. ORGANIZATION TABLE (ENHANCED WITH ID)
...
-- 4. MEETINGS TABLE (NEW - ALIGNED WITH SOURCE)
...
-- 5. MEETING SESSION TABLE (ENHANCED WITH ID)
...
-- 6. PARTICIPANTS TABLE (NEW - ALIGNED WITH SOURCE)
...
-- 7. MEETING PARTICIPANT TABLE (ENHANCED WITH ID)
...
-- 8. FEATURE USAGE TABLE (NEW - ALIGNED WITH SOURCE)
...
-- 9. WEBINARS TABLE (NEW - ALIGNED WITH SOURCE)
...
-- 10. WEBINAR EVENT TABLE (ENHANCED WITH ID)
...
-- 11. SUPPORT TICKETS TABLE (NEW - ALIGNED WITH SOURCE)
...
-- 12. LICENSES TABLE (NEW - ALIGNED WITH SOURCE)
...
-- 13. BILLING EVENTS TABLE (NEW - ALIGNED WITH SOURCE)
...
-- 14. RECORDING ASSET TABLE (ENHANCED WITH ID)
...
-- 15. DEVICE CONNECTION TABLE (ENHANCED WITH ID)
...
-- 16. CHAT COMMUNICATION TABLE (ENHANCED WITH ID)
...
-- 17. SCREEN SHARE SESSION TABLE (ENHANCED WITH ID)
...
-- 18. BREAKOUT ROOM TABLE (ENHANCED WITH ID)
...
-- 19. USAGE ANALYTICS TABLE (ENHANCED WITH ID)
...
-- 20. QUALITY METRICS TABLE (ENHANCED WITH ID)
...
-- 21. ENGAGEMENT METRICS TABLE (ENHANCED WITH ID)
...
-- 22. RESOURCE UTILIZATION TABLE (ENHANCED WITH ID)
...
-- 23. SECURITY EVENT TABLE (ENHANCED WITH ID)
