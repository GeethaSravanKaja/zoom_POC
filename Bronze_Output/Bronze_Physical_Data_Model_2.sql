...
## *Version*: 2
## *Updated on*: 
## *Changes*: Removed API cost information including billing transaction table
## *Reason*: User requested removal of API cost information to streamline the data model
_____________________________________________
